      ...
      <div class="mui-card-content">
        <div class="mui-card-content-inner">
          ...
          <p>
            ...
            <mt-button type="danger" size="small" @click="addCate">加入购物车       </mt-button>
...
// 点击使用编程式导航跳转到 图文介绍页面
 ...
 // { id:商品的id, count: 要购买的数量, price: 商品的单价，selected: false  }
      ...
      this.$store.commit("addCate", goodsinfo);
    },
    ...
    enter(el, done) {
      ...
      el.style.transition = "all 1s cubic-bezier(.09,.75,1,.36)";
      done();
    },
    afterEnter(el) {
      this.ballFlag = !this.ballFlag;
